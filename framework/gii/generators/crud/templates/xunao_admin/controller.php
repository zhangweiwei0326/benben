...
class <?php echo $this->controllerClass; ?> extends <?php echo "BaseController"."\n"; ?>
{
	/**
...
*/
	...
	public function actionDelete($id)
	{
		...
		$this->redirect ( Yii::app()->createUrl('<?php echo $this->controller?>/index',array('page'=>intval($_REQUEST['page']))));
	}
	...
	{
		return Yii::app()->createUrl("<?php echo $this->controller;?>/index",array('page'=>$_REQUEST['page']));
	}
