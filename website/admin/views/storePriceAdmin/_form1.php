...
?>
<style>
	.names input{display: inline;}
	.addnames{margin-top: 10px;}
	.deleten{padding: 2px 4px;font-size: 14px;margin-left: 10px;}
</style>
		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			...
			'enableAjaxValidation'=>false,
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input readonly="readonly" class="form-control" size="60" maxlength="255" name="StorePriceAdmin[type]" id="StorePriceAdmin_type" type="text" value="<?php echo $arr_type[$model->type]?>">
						<?php echo $form->textField($model,'type',array('class'=>'form-control','size'=>'60','maxlength'=>'255','style'=>'display:none'));//$form->dropDownList($model,'type', $arr_type,array('class'=>'form-control')); ?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						<ul class="names">
						<?php
							$names_arr = explode(",",$model->names);
							foreach($names_arr as $key=>$va){
								$va_arr = explode(":",$va);
								echo '<li>数量:&nbsp;&nbsp;<input style="width:20%" class="form-control" size="60" maxlength="255" name="StorePriceAdmin[names]['.$key.'][]" type="text" value="'.$va_arr[0].'">人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;单价:&nbsp;&nbsp;<input style="width:20%" class="form-control" size="60" maxlength="255" name="StorePriceAdmin[names]['.$key.'][]" type="text" value="'.$va_arr[1].'">元<div class="btn btn-success btn-lg deleten">删除</div></li>';
							}
						?>
							<li class="btn btn-success btn-lg addnames">增加</li>
						</ul>
						<?php }else{
							echo $form->textField($model,'names',array('class'=>'form-control','size'=>'60','maxlength'=>'255'));
						}?>
<!--						<input class="form-control" size="60" maxlength="255" name="StorePriceAdmin[names]" type="text" value="">-->
...
<script>
	$(function(){
		...
		$(".addnames").click(function(){
			...
			$(this).prev().after('<li>数量:&nbsp;&nbsp;<input style="width:20%" class="form-control" size="60" maxlength="255" name="StorePriceAdmin[names]['+index+'][]" type="text" value="">人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;单价:&nbsp;&nbsp;<input style="width:20%" class="form-control" size="60" maxlength="255" name="StorePriceAdmin[names]['+index+'][]" type="text" value="">元<div class="btn btn-success btn-lg deleten">删除</div></li>');
		});
