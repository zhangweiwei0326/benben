...
?>
		...
		<div class="main_right_content_title">
			<div class="main_right_content_title_font">好友联盟启/禁用管理</div>
			<div class="main_right_content_content_block_action_add">
				<a class="btn btn-success" href="javascript:goBack();<?php //echo Yii::app()->createUrl("friend/index");?>">返回</a>
			</div>
		</div>
			...
			<table cellspacing=1 border="0" class="table table-hover">
				<thead>
					<tr class="main_right_content_content_title">
						<td width="15%"><?php echo $type ? "联盟名称" : "创建人";?></td><td width="15%">状态</td><td width="15%">操作人</td><td width="35%">操作原因</td>
						<td width="35%">操作时间</td>
					</tr>
				</thead>
				<tbody>
					...
					$edit_url = Yii::app()->createUrl('friendDisable/update',array('id'=>$item->id,'page'=>$_REQUEST['page']));
					?>
	...
	<input id="del_baseurl" type="hidden" value="<?php echo Yii::app()->createUrl("friendDisable/delete",array('page'=>$pages->currentPage +1));?>" />
