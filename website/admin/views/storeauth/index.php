...
<div class="main_right_content_content" style="background: #F5F5F5;">
    <form
      action="<?php echo Yii::app()->createUrl('storeAuth/index')?>" method="get">
        <ul style="margin-top: 0">
            ...
            <li style="width:18%">
                <div class="form-group" style="padding: 0 0 0 5px;">
                    <label for="type" style="float: left; margin-top: 7px;">类　　型:</label>
                    <div class="col-sm-8" style="margin-bottom: 10px;">
            ...
            <li style="width:50%;">
            	<div class="form-group row" style="float:left;">
            		<label class="col-md-4" for="shopNum" style="float: left; margin-top: 7px;">店    铺    号:</label>
					<input class="col-md-6"type="text" class="form-control" style="float:left;margin-left: 10px;font-family: cursive;color: cornflowerblue;font-size: x-large;"
                    		name="store_no" id="store_no" placeholder="店铺号hz+奔犇号"/>
				</div>
            </li>
            <li style="width:7% ">
                <input
                type="submit" style="width: 60px;height: 35px;" class="btn btn-success" value="查询" id="submit_search">
            </li>
            <li style="width:7%;">
                <span type="submit" style="width: 60px;height: 35px;margin-left: 25px;"class="btn btn-primary" id="search_clear">清空</span>
            </li>
        ...
        <input type="button" style ="width:150px;height:30px;float:left;margin-left: 45px;border:1px #000000 solid;background-color: #FFFFFF;" value="批量拒绝" class="refuseAllAuth">
