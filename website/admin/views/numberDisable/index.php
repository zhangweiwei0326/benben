<?php
/* @var $this NumberDisableController */
...
?>
		...
		<div class="main_right_content_title">
			<div class="main_right_content_title_font">直通车启/禁用管理</div>
		...
		<div class="main_right_content_content">
			...
			<div class="jl" style="width:96%;padding:2% 2% 2% 2%;border-bottom:2px solid #ccc;margin-left:2%;">
				...
				<br>
				<span style="font-size:16px;"><strong>操作人: </strong><?php echo $item->uname ?></span>
				<br>
	...
	<input id="del_baseurl" type="hidden" value="<?php echo Yii::app()->createUrl("numberDisable/delete",array('page'=>$pages->currentPage +1));?>" />
