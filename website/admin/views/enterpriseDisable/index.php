<?php
/* @var $this EnterpriseDisableController */
...
?>
	...
	<input id="del_baseurl" type="hidden" value="<?php echo Yii::app()->createUrl("enterpriseDisable/delete",array('page'=>$pages->currentPage +1));?>" />
