...
<div class="main_right_content_content" style="background: #F5F5F5;">
    <form
        ...
        <ul style="margin-top: 0">
            ...
            <li style="width:50%;">
                <div class="form-group row" style="margin:5px 0 0 5px;float:left;">
                    <label class="col-md-4" for="shopNum" style="float:left;font-size: larger;color: brown;">店铺号:</label>
            ...
            <li style="width:7% ">
                <input
                    type="submit" style="width: 100px;height: 35px;" class="btn btn-success" value="查询" id="submit_search">
            </li>
            <li style="width:7%;">
                <span type="submit" style="width: 100px;height: 35px;"class="btn btn-primary" id="search_clear">清空</span>
            </li>
