...
<div class="main_right_content">
	<ol class="breadcrumb main_right_content_breadcrumb">
		<li><a href="<?php echo Yii::app()->createUrl('authentication/index')?>">认证管理</a></li>
		<li><a href="#">认证详情</a></li>
	</ol>
	<div class="main_right_content_content">
			<div style="margin-left: 200px;font-size: 15px;">			
                <div class="col-md-12" style="margin:5px 0 0 5px;float:left;">
					...
					<label  for="shopNum" style="float:left;margin-left: 50px;font-family: cursive;color: cornflowerblue;font-size: x-large;">125458487</label>
				</div>
