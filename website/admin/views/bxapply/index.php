    ...
    <div class="main_right_content_content" style="background:#F5F5F5;">
        ...
        <form action="<?php echo Yii::app()->createUrl('bxapply/index') ?>" method="get">
            <ul style="margin-top:0;">
                ...
                <li style="width:18%">
                    <div class="form-group" style="padding:0 0 0 5px;">
                        ...
                        <div class="col-sm-8" style="margin-bottom:10px;">
                            <input type="text" class="form-control" name="short_phone" id="short_phone"
                                   value="<?php echo $result['short_phone'] ?>">
                        </div>
                    </div>
                </li>
                <li style="width:18%">
                    <div class="form-group" style="padding:0 0 0 5px;">
                        ...
                        <div class="col-sm-8" style="margin-bottom:10px;">
                            <input type="text" class="form-control" name="member_id" id="member_id"
                                   value="<?php echo $result['member_id'] ?>">
                        </div>
                    </div>
                </li>
                ...
                <?php if ($role_arr['dobaixing'] & 2) { ?>
                    <li style="float:right;text-align:right;width:70px;padding-right:20px;">
                        <a href="/admin.php/bxapply/phpexcel?<?php echo $url ?>">
                            <div class="btn btn-primary" id="putexcel">导出</div>
                        </a>
                    </li>
                <?php } ?>
            ...
            <ul class="member_ul">
                <li>
                    <div class="form-group" style="padding:0 0 0 5px;">
                        ...
                        <div class="col-sm-8" style="margin-bottom:10px;">
                            <input type="text" class="form-control created_time" name="created_time1" id="created_time1"
                ...
                <li>
                    <div class="form-group" style="padding:0 0 0 5px;">
                        ...
                        <div class="col-sm-8" style="margin-bottom:10px;">
                            <input type="text" class="form-control created_time" name="created_time2" id="created_time2"
                    ...
                    <div class="form-group" style="padding:0 0 0 5px;">
                        ...
                        <div class="col-sm-8" style="margin-bottom:10px;">
                            <select class="form-control" name="status" id="status">
                                ...
                                <option value="0" <?php if ($result['status'] == 0) echo 'selected = "selected"'; ?>>
                                    等待审核
                                </option>
                                <option value="1" <?php if ($result['status'] == 1) echo 'selected = "selected"'; ?>>
                                    未通过
                                </option>
                                <option value="2" <?php if ($result['status'] == 2) echo 'selected = "selected"'; ?>>
                                    退回重申
                                </option>
                                <option value="3" <?php if ($result['status'] == 3) echo 'selected = "selected"'; ?>>
                                    已经通过
                                </option>
                                <option value="4" <?php if ($result['status'] == 4) echo 'selected = "selected"'; ?>>
                                    撤消
                                </option>
                            </select>
                        </div>
                ...
                <li>
                    <div class="form-group" style="padding:0 0 0 5px;">
                        ...
                        <div class="col-sm-8" style="margin-bottom:10px;">
                            <input type="text" class="form-control created_time" name="cancel_time1" id="cancel_time1"
                                   value="<?php echo $result['cancel_time1'] ?>">
                        </div>
                    </div>
                </li>
                <li>
                    <div class="form-group" style="padding:0 0 0 5px;">
                        ...
                        <div class="col-sm-8" style="margin-bottom:10px;">
                            <input type="text" class="form-control created_time" name="cancel_time2" id="cancel_time2"
                                   value="<?php echo $result['cancel_time2'] ?>">
                        </div>
                    </div>
                </li>
            </ul>
            <ul class="member_ul">
                        ...
                        <div class="col-sm-8" style="margin-bottom:10px;">
                            <select class="form-control" name="province" id="province">
                                ...
                                <?php foreach ($province as $prv) { ?>
                                    <option
                                        value="<?php echo $prv->bid ?>" <?php if ($result['province'] == $prv->bid) echo 'selected = "selected"'; ?>><?php echo $prv->area_name ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                ...
                <li>
                    <div class="form-group" style="padding:0 0 0 5px;">
                        <label for="enterprise" style="float:left;margin-top:7px;">百姓网段:</label>
                        <div class="col-sm-8" style="margin-bottom:10px;">
                            <select class="form-control" name="enterprise" id="enterprise">
                                <option value="-1">--请选择网段--</option>
                                <?php if (isset($enterprise)) {
                                    foreach ($enterprise as $prv) { ?>
                                        <option value="<?php echo $prv['id']; ?>"
                                            <?php if ($result['enterprise_id'] == $prv['id']) echo 'selected = "selected"'; ?>><?php echo $prv['name'] ?></option>
                                    <?php }
                                } ?>
                            </select>
                        </div>
        ...
        <table cellspacing=1 border="0" class="table table-hover">
            ...
            foreach ($items as $item) {
                ...
                <tr class="main_right_content_content_body <?php if ($item->status == 4) echo 'danger'; ?>">
                    ...
                    <td>
                        <a href="<?php echo Yii::app()->createUrl('bxapplyRecord/index?id=' . $item->id) ?>"><?php echo $status[$item->status] ?></a>
                    </td>

                    <td>
                        <?php if ($role_arr['dobaixing'] & 1) { ?><a class="btn btn-primary btn-sm"
                                                                     href="<?php echo $edit_url ?>&back=<?php echo $result['goback'] ?>">
                                编辑</a><?php } ?>
...
<input id="del_baseurl" type="hidden"
       value="<?php echo Yii::app()->createUrl("bxapply/delete", array('page' => $pages->currentPage + 1)); ?>"/>
