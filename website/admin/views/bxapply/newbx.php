...
<div class="main_right_content">
    ...
    <div class="main_right_content_content" style="background:#F5F5F5;">
        ...
        <?php }?>
        <form action="<?php echo Yii::app()->createUrl('bxapply/newbx')?>" method="get">
            <ul style="margin-top:0;">
                ...
                <li style="float:right;text-align:right;width:60px;padding-right:10px;">
                    <a href="<?php echo Yii::app()->createUrl('bxapply/createbx')?>" class="btn btn-primary" id="new_bx">新建</a>
                </li>
            </ul>
            <ul class="member_ul">
                <li>
        ...
        <table cellspacing=1 border="0" class="table table-hover">
            ...
            foreach ( $items as $item ) {
                $edit_url = Yii::app()->createUrl('bxapply/changeinfo',array('id'=>$item->id,'page'=>$_REQUEST['page']));
                ?>
