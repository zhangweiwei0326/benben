		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			...
			'enableAjaxValidation'=>false,
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?php echo $form->textField($model,'store_id', array('class'=>'form-control')); ?>
					</div>
				</div>
				<div class="form-group">
					<?php echo $form->labelEx($model,'price', array("class"=>"col-sm-2 control-label"));?>
					<div class="col-sm-8">
						<?php echo $form->textField($model,'price',array('class'=>'form-control','size'=>'20','maxlength'=>'20')); ?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<?php echo $form->labelEx($model,'accept', array("class"=>"col-sm-2 control-label"));?>
					<div class="col-sm-8">
						<?php echo $form->textField($model,'accept', array('class'=>'form-control')); ?>
					</div>
				</div>
				<div class="form-group">
