<?php
/* @var $this FriendCommentController */
...
?>
		...
		<div class="main_right_content_title">
			<div class="main_right_content_title_font">朋友圈评论管理</div>
		...
		<div class="main_right_content_content">
			<table cellspacing=1 border="0" class="table table-hover">
				...
				<tbody>
					...
					$edit_url = Yii::app()->createUrl('friendComment/update',array('id'=>$item->id,'page'=>$_REQUEST['page']));
					?>
	...
	<input id="del_baseurl" type="hidden" value="<?php echo Yii::app()->createUrl("friendComment/delete",array('page'=>$pages->currentPage +1));?>" />
