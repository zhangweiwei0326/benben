<?php
/* @var $this MemberDisableController */
...
?>
		...
		<div class="main_right_content_title">
			<div class="main_right_content_title_font">用户禁/启用管理</div>
			<div class="main_right_content_content_block_action_add">
				<a class="btn btn-success" href="javascript:goBack();<?php //echo Yii::app()->createUrl("member/index");?>">返回</a>
			</div>
		</div>
	...
	<input id="del_baseurl" type="hidden" value="<?php echo Yii::app()->createUrl("memberDisable/delete",array('page'=>$pages->currentPage +1));?>" />
