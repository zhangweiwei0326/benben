<?php
/* @var $this GroupDisableController */
...
?>
		...
		<div class="main_right_content_title">
			<div class="main_right_content_title_font">群组启/禁用管理</div>
	...
	<input id="del_baseurl" type="hidden" value="<?php echo Yii::app()->createUrl("groupDisable/delete",array('page'=>$pages->currentPage +1));?>" />
