...
class Role extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id, role_name, domember, dobaixing, doenterprise, dogroup, dostore, docreation, dorelease, dofriend, doshop, dohappy, donews, dowebsite, dosystem, created_time, doleague, dofind, doother, doservice, dopay, doapplyregister, enterprise_id', 'safe', 'on' => 'search'),
        );
    }
