 ...
 *
 * The followings are the available columns in table 'store_shipping':
 * @property integer $id
 * @property string $name
 * @property string $image
 * @property integer $created_time
 */
class StoreShipping extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('shipping_name,shipping_code', 'length', 'max'=>255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('shipping_id, shipping_name,shipping_code, is_del', 'safe', 'on'=>'search'),
        );
    }
