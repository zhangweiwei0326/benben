...
class ApplyComplete extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('apply_id, type, member_id, created_time, province, city, area, street', 'numerical', 'integerOnly'=>true),
			...
			array('id, apply_id, id_card, poster1, poster2, type, member_id, created_time, name, phone, province, city, area, street', 'safe', 'on'=>'search'),
		);
	}
