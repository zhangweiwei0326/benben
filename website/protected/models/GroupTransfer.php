 ...
 */
class GroupTransfer extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('huanxin_groupid, from_huanxin, to_huanxin', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, huanxin_groupid, from_huanxin, to_huanxin, createtime', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('huanxin_groupid',$this->huanxin_groupid);
