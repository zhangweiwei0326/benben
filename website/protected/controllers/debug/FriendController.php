...
class FriendController extends PublicController
{
	...
	public function actionMylist(){
		...
		$sql = "select b.id MemberId,b.nick_name Name,b.name rname,b.benben_id,b.poster Poster,a.id Id,a.description Description,a.views Views,a.created_time CreatedTime,a.status from friend a inner join member b on a.member_id = b.id where a.is_delete = 0 and b.id = {$user->id} order by a.created_time desc limit 10";
		if($last_time){
			...
			$sql = "select b.id MemberId,b.nick_name Name,b.name rname,b.benben_id,b.poster Poster,a.id Id,a.description Description,a.views Views,a.created_time CreatedTime,a.status from friend a inner join member b on a.member_id = b.id where a.is_delete = 0 and a.created_time < {$last_time} and b.id = {$user->id} order by a.created_time desc limit 10";
		}
		...
		if($creationid){
			...
			//查询评论
			$sql2 = "select a.circle_id,a.member_id,a.review,a.created_time,b.nick_name,b.name rname,b.benben_id from friend_comment a inner join member b on a.member_id = b.id where a.circle_id in ({$creationid}) order by a.created_time asc";
