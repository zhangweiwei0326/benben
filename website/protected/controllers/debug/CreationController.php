...
class CreationController extends PublicController
{
	...
	public function actionMylist(){
		...
		if($keyword){
			...
			$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime,a.status from creation a inner join member b on a.member_id = b.id where a.description like '%{$keyword}%' and b.id = {$user->id} order by a.created_time desc limit 10";
			if($last_time){
				$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime,a.status from creation a inner join member b on a.member_id = b.id where a.description like '%{$keyword}%' and a.created_time < {$last_time} and b.id = {$user->id} order by a.created_time desc limit 10";
			}
		}else{
			$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime,a.status from creation a inner join member b on a.member_id = b.id where b.id = {$user->id} order by a.created_time desc limit 10";
			if($last_time){
				$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime,a.status from creation a inner join member b on a.member_id = b.id where a.created_time < {$last_time} and b.id = {$user->id} order by a.created_time desc limit 10";
			}
		}
	...
	**/
	...
	public function actionList(){		
		...
		if($islike){
			if($authid){
				if($keyword){
					$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime from creation a inner join member b on a.member_id = b.id where a.member_id in ({$authid}) and a.description like '%{$keyword}%' and a.status = 0 order by a.created_time desc limit 10";
					if($last_time){
						$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime from creation a inner join member b on a.member_id = b.id where a.member_id in ({$authid}) and a.description like '%{$keyword}%' and a.status = 0 and a.created_time < {$last_time} order by a.created_time desc limit 10";
					}
				}else{
					$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime from creation a inner join member b on a.member_id = b.id where a.member_id in ({$authid}) and a.status = 0 order by a.created_time desc limit 10";
					if($last_time){
						$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime from creation a inner join member b on a.member_id = b.id where a.member_id in ({$authid}) and a.status = 0 and a.created_time < {$last_time} order by a.created_time desc limit 10";
					}
				}
				$command = $connection->createCommand($sql);
				$result0 = $command->queryAll();
			...
			if($keyword){
				$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime from creation a inner join member b on a.member_id = b.id where a.description like '%{$keyword}%' and a.status = 0 order by a.created_time desc limit 10";
				if($last_time){
					$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime from creation a inner join member b on a.member_id = b.id where a.description like '%{$keyword}%' and a.status = 0 and a.created_time < {$last_time} order by a.created_time desc limit 10";
				}
			}else{
				$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime from creation a inner join member b on a.member_id = b.id where a.status = 0 order by a.created_time desc limit 10";
				if($last_time){
					$sql = "select b.id MemberId,b.benben_id,b.nick_name Name,b.poster Poster,a.id Id,a.description Description,a.type Type,a.views Views,a.created_time CreatedTime from creation a inner join member b on a.member_id = b.id where a.status = 0 and a.created_time < {$last_time} order by a.created_time desc limit 10";
				}
			}
			$command = $connection->createCommand($sql);
			$result0 = $command->queryAll();
